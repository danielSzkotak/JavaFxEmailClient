...
import com.example.javafxemailclient.view.ColorTheme;
import com.example.javafxemailclient.view.FontSize;
...
public class OptionsWindowController extends BaseController implements Initializable {
    ...
    //Method called right after object is created
    @Override
    ...
    private void setUpSizePicker() {
        ...
        fontSizePicker.setValue(viewFactory.getFontSize().ordinal());  // ordinal gives double from ENUM
